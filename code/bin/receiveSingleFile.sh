...
echo "`date`: Caller: $AETitleCaller, calling $AETitleCalled from $CallerIP in $DIR" >> /data/logs/receivedSingleFile.log
...
echo "`date`: Process incoming data for processing in $DIR" >> /data/logs/receivedSingleFile.log